...
import regionAqchour from "@/assets/region-aqchour.png";
import regionNador from "@/assets/region-nador.png";
import regionFes from "@/assets/region-fes.png";
import regionRabat from "@/assets/region-rabat.png";
import regionBeniMellal from "@/assets/region-beni-mellal.png";
import regionCasa from "@/assets/region-casa.png";
import regionMarrakech from "@/assets/region-marrakech.png";
import regionDraaTafilalet from "@/assets/region-draa-tafilalet.png";
import regionSoussMassa from "@/assets/region-souss-massa.png";
import regionGuelmimOuedNoun from "@/assets/region-guelmim-oued-noun.png";
import regionLaayouneSakiaElHamra from "@/assets/region-laayoune-sakia-el-hamra.png";
import regionDakhla from "@/assets/region-dakhla.png";
...
export const REGION_META: Record<string, RegionMeta> = {
  ...
  LAAYOUNE_SAKIA_EL_HAMRA: {
    x: 24, y: 58,
    image: regionLaayouneSakiaElHamra,

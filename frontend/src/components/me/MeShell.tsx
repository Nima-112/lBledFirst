  ...
  return (
    <div className="min-h-screen bg-muted/40">
      ...
      <div className="mx-auto max-w-5xl px-4 py-6 sm:px-6">
        ...
        <p className="mb-6 text-sm text-muted-foreground">{t("me.greeting")}, {user.name.split(" ")[0]}.</p>
        ...
        <nav className="mb-6 flex flex-wrap gap-2">
          ...
          <button
            type="button"
            onClick={() => void logout()}
            className="inline-flex items-center gap-2 rounded-full border border-destructive/40 bg-destructive/10 px-4 py-2 text-sm font-semibold text-destructive transition hover:bg-destructive hover:text-destructive-foreground"
          >

...
public class UserService extends AbstractCrudService<User, Long> {
    ...
    public UserResponse createUser(UserRequest req) {
        if (userRepository.findByEmail(req.getEmail()).isPresent()) {
            throw new ResponseStatusException(HttpStatus.CONFLICT, "This email already in use");
        }
        ...
        User user = User.builder()
                ...
                .country(req.getCountry() != null ? req.getCountry() : "Morocco")
                ...
                .specialty(req.getSpecialty() != null ? req.getSpecialty() : "")
                .experienceYears(req.getExperienceYears() != null ? req.getExperienceYears() : 0)
                .hostRegion(req.getHostRegion() != null ? req.getHostRegion() : "")
                .emailVerified(true)
                .build();
    ...
    public void delete(Long id) {
        ...
        experienceFavoriteRepository.deleteByUserId(id);
